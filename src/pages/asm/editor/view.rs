...
pub fn asm_editor(props: &Props) -> Html {
    ...
    let is_current = current_tab.registers.rip == instruction.address;
    ...
    html! {
        <div
            data-index={props.instr_index.to_string()}
